          ...
          blr_any,
            blr_rse, 1,
              ...
              blr_boolean,
                blr_and,
                  blr_missing,
                    blr_field, 5, 16, 'R','D','B','$','P','A','C','K','A','G','E','_','N','A','M','E',
                  blr_eql,
    ...
    blr_if,
      blr_and,
        ...
        blr_not,
          blr_any,
            blr_rse, 1,
              blr_relation, 13, 'R','D','B','$','F','U','N','C','T','I','O','N','S', 25,
              blr_boolean,
                blr_and,
                  blr_missing,
                    blr_field, 25, 16, 'R','D','B','$','P','A','C','K','A','G','E','_','N','A','M','E',
                  blr_eql,
                    blr_field, 25, 17, 'R','D','B','$','F','U','N','C','T','I','O','N','_','N','A','M','E',
                    blr_field, 1, 17, 'R','D','B','$','R','E','L','A','T','I','O','N','_','N','A','M','E',
              blr_end,
      blr_leave, 0,
      blr_end,
    blr_if,
      blr_and,
        ...
        blr_not,
          blr_any,
            blr_rse, 1,
              blr_relation, 12, 'R','D','B','$','P','A','C','K','A','G','E','S', 21,
              blr_boolean,
                blr_eql,
                  blr_field, 21, 16, 'R','D','B','$','P','A','C','K','A','G','E','_','N','A','M','E',
                  blr_field, 1, 17, 'R','D','B','$','R','E','L','A','T','I','O','N','_','N','A','M','E',
              blr_end,
      blr_leave, 0,
      blr_end,
