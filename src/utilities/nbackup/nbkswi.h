...
const int IN_SW_NBK_KEEP_DAYS		= 19;
const int IN_SW_NBK_KEEP_ROWS		= 20;
...
static const struct Switches::in_sw_tab_t nbackup_action_in_sw_table [] =
{
	...
	{IN_SW_NBK_KEEP_DAYS,	isc_spb_nbk_keep_days,	"KEEP_DAYS",		0, 0, 0, false, false,	83, 6,	NULL, nboSpecial},
	{IN_SW_NBK_KEEP_ROWS,	isc_spb_nbk_keep_rows,	"KEEP_ROWS",		0, 0, 0, false, false,	84, 6,	NULL, nboSpecial},
